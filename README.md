...
.
	...
	ffuf -u https://site.com/FUZZ -w /usr/share/dirb/wordlists/big.txt -mc all -c -t 100 -e php,bkp,old,txt,xml,cgi,pdf,html,htm,asp,aspx,pl,sql,js,png,jpg,jpeg,config -o ffuf-output	
